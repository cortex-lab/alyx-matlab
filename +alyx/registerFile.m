function [dataset, filerecord] = registerFile(filePath, dataFormatName, session, datasetTypeName, parentDatasetURL, alyxInstance)
...
if ischar(session)
    ...
    [status,body] = http.jsonGet(session, 'Authorization', ['Token ' alyxInstance.token]);
