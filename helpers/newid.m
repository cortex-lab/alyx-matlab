...
set(InputFig,'Position',getnicedialoglocation_for_newid(FigPos,get(InputFig,'Units')));
...
setdefaultbutton_for_newid(InputFig, OKHandle);
...
function figure_size = getnicedialoglocation_for_newid(figure_size, figure_units)
...
function setdefaultbutton_for_newid(figHandle, btnHandle)
